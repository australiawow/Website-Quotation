...
class Project extends Model
{
    ...
    /**
     * Get project Google Drive folder and access.
     * @param int $id
     * @return bool
     */
    public function getGDrive($id)
    {
        return $this->rest->get("$this->action/$id/googleDrive");
    }
     ...
     * @return bool
     */
    public function setGDrive($id, $params)
    {
        $id = (int) $id;
        if ($id <= 0) {
            throw new Exception('Invalid param id');
        }
        return $this->rest->put("$this->action/$id/googleDrive", $params);
    }
}